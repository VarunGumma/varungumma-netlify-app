...
// Toggle between light and dark only. The upstream theme also cycles through a
// "system" setting; that third state is intentionally dropped here.
...
let determineThemeSetting = () => {
  ...
  if (themeSetting != "dark" && themeSetting != "light") {
    // First visit, or a legacy "system" value left in localStorage: seed from the
    // OS preference once, then treat it as an explicit light/dark choice so the
    // toggle never lands back on the system state.
